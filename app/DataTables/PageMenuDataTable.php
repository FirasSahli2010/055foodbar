...
class PageMenuDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $editBtn ="<a href='".route('menupage.edit', $query->id)."'class='btn btn-primary '><i class='far fa-edit'></i></a>";
            $deleteBtn="<a href='".route('menupage.destroy', $query->id)."'class='btn btn-danger ml-2 delete-item'> <i class ='far fa-trash-alt'></i></a>";
            ...
            <a class="dropdown-item has-icon" href="'.route('menu-variant-item.index',['productId'=> $query->id]).'"><i class="far fa-file"></i>Select-Size</a>
            <a class="dropdown-item has-icon" href="'.route('menu-option-item.index',['productId'=> $query->id]).'"><i class="far fa-file"></i>Select-Options</a>
          ...
          return $editBtn.$deleteBtn.$moreBtn;
            ...
            ->rawColumns(['thumb_image','status','action','type'])
            ->setRowId('id');
    }
