            ...
            <div class="row">
                <div class="col-xl-6 col-md-8">
                    <ul class="fp__topbar_info d-flex flex-wrap">
                        <li><a href="mailto:example@gmail.com"><i class="fas fa-envelope"></i> info@055Foodbar.nl</a>
                        </li>
                        <li><a href="callto:123456789"><i class="fas fa-phone-alt"></i> 06123456789</a></li>
                    </ul>
                </div>
