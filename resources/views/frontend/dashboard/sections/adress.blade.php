                            ...
                            <div class="fp__checkout_single_address">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        ...
                                        <span class="address"> Adress : {{$address->address}},{{$address->deliveryArea?->area_name}}</span>
                                    </label>
                                </div>
                                <ul>
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <div class="fp__check_single_form">
                                    <select id="select_js4" name="area">
                                        <option value="">select-Stad</option>
                                        @foreach ($deliveryAreas as $area)
                                            <option @selected($address->delivery_id === $area->id) value="{{ $area->id }}">{{$area->area_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
